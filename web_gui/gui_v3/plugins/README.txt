...
The requirement for a plugin are:
 ...
 -php file called plugin.php which contains a class which match you plugin name

The plugin class expend a class called plugin which contains all the existings callback.
