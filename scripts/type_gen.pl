...
foreach $index (sort {0+$a <=> 0+$b}  keys %attrlist )
{
	...
	{
		print OUTPUT "\t{ \"".${$attrlist{$index}}{name}."\", \t".${$attrlist{$index}}{dbtype}.", \t".(${$attrlist{$index}}{len}-1).", \t".${$attrlist{$index}}{flags}.", offsetof(entry_info_t, ".${$attrlist{$index}}{name}.") , ".${$attrlist{$index}}{gen_from}.", ".${$attrlist{$index}}{gen_func}." }, \n";
	}
	else
	{
		print OUTPUT "\t{ \"".${$attrlist{$index}}{name}."\", \t".${$attrlist{$index}}{dbtype}.", \t".(${$attrlist{$index}}{len}-1).", \t".${$attrlist{$index}}{flags}.", offsetof(entry_info_t, ".${$attrlist{$index}}{name}."), ".${$attrlist{$index}}{gen_from}.", ".${$attrlist{$index}}{gen_func}." }\n";
