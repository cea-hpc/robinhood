...
function test_copy
{
    ...
    diff -q $RH_ROOT/backup/*/file.2 "$RH_ROOT/file.2" || error "Source and target file.2 differ"
    grep "Error applying action on entry /mnt/lustre/file.3" rh_migr.log || error "copy of file.3 should have failed"
